...
Installation Guides:
  ...
  * Install FFMPEG 
      - On Windows 
      [FFMPEG builds](https://www.gyan.dev/ffmpeg/builds), extract it and add it to your path [How to add FFMPEG to Path](https://www.thewindowsclub.com/how-to-install-ffmpeg-on-windows-10#:~:text=Add%20FFmpeg%20to%20Windows%20path%20using%20Environment%20variables&text=In%20the%20Environment%20Variables%20window,bin%5C%E2%80%9D%20and%20click%20OK.)
      - On MacOs
      Alternatively, use `homebrew` to install FFMPEG for MacOS. Use the following command
      ```
      $ brew install ffmpeg
      ```
